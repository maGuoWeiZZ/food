                        ...
                        <div class="table-responsive" style="overflow: auto;height: 500px;">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${requestScope.foodsList}" var="foods">
                                    <form action="${path}foodsServlet?action=deleteFoods" method="post"
                                          onsubmit="return confirm('是否删除餐饮商品【${foods.name}】？')">
                                        <tr>
                                            ...
                                            <td class="text text-center"
                                                style="vertical-align: middle;">${foods.id}</td>
                                            <td class="text text-center"
                                                style="vertical-align: middle;">${foods.name}</td>
                                            <td class="text text-center"
                                                style="vertical-align: middle;">${foods.type}</td>
                                            <td class="text text-center" style="vertical-align: middle;">
                                                &yen;${foods.price}</td>
                                            <td class="text text-center"
