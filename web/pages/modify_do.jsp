            ...
            <section class="col-md-12 col-sm-12 col-xs-12">
                <div class="box form">
                    <div class="box-header">
                        <h3 class="box-title">修改餐饮商品</h3>
                    </div>
                    <div class="box-body">
                        <form name="form1" action="${path}foodsServlet?action=modifyFoods" method="post"
                        onsubmit="return checkFoodsModi()">
                            <div class="form-group">
                                <label id="msg" class="label label-danger"></label>
                            </div>
                            <input type="hidden" name="id" value="${foods.id}">
                            <input type="hidden" name="type1" value="${foods.type}">
                            <input type="hidden" name="state1" value="${foods.state}">
                            <div class="form-group">
                                <label>名称</label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="state" class="form-control">
                                    <option value="">--请选择餐饮商品状态--</option>
                                    <option value="在售">在售</option>
                                    <option value="已下架">已下架</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>清空月销量<input type="checkbox" name="monthCount" value="true">
                                </label>
                            </div>
                            <input type="hidden" name="count" value="${foods.monthCount}">
        ...
        <script type="text/javascript">
            function checkFoodsModi() {
                ...
                if (form1.name.value == '' || form1.name.value == null) {
                    ...
                    return false;
                } else if (form1.state.value == '' || form1.state.value == null) {
