                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text text-center">权限</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${requestScope.userList}" var="user">
                                    <tr>
                                        <td class="text text-center" style="vertical-align: middle;">${user.uid}</td>
                                        <td class="text text-center"
                                            style="vertical-align: middle;">${user.username}</td>
                                        <td class="text text-center"
                                            style="vertical-align: middle;">${user.realName}</td>
                                        <td class="text text-center" style="vertical-align: middle;">${user.phone}</td>
                                        <td class="text text-center" style="vertical-align: middle;">${user.email}</td>
