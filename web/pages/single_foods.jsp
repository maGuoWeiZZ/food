                                ...
                                <tr>
                                    <c:if test="${not empty foods}">
                                        ...
                                        <td class="text text-center"
                                            style="vertical-align: middle;">${requestScope.foods.id}</td>
                                        <td class="text text-center"
                                            style="vertical-align: middle;">${requestScope.foods.name}</td>
                                        <td class="text text-center"
                                            style="vertical-align: middle;">${requestScope.foods.type}</td>
                                        <td class="text text-center" style="vertical-align: middle;">
                                            &yen;${requestScope.foods.price}</td>
                                        <td class="text text-center"
                                            style="vertical-align: middle;">${requestScope.foods.monthCount}</td>
                                        <c:if test="${requestScope.foods.state.equals(\"在售\")}">
                                            <td class="text text-center" style="vertical-align: middle;">
                                        ...
                                        <c:if test="${requestScope.foods.state.equals(\"已下架\")}">
                                            <td class="text text-center" style="vertical-align: middle;">
                                    ...
                                    <c:if test="${empty foods}">
                                        <span class="text-danger">未查询到结果！</span>
                                    </c:if>
                                </tr>
                                </tbody>
                            </table>
